...
{
    public GameObject[] adminPrefabs;
    ...
    private GameObject spawnedAdminPref;
    ...
    {
        Debug.Log("Spawning Admin " + PhotonNetwork.CurrentRoom.PlayerCount);
        spawnedAdminPref = PhotonNetwork.Instantiate(adminPrefabs[selectedPrefab].name, spawnPoints[PhotonNetwork.CurrentRoom.PlayerCount - 1].position, spawnPoints[PhotonNetwork.CurrentRoom.PlayerCount - 1].rotation);
